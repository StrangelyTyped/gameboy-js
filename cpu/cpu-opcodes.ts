...
const opcodeGroups = [
    ...
    new OpcodeGroup(PrimaryGroupNames.loadRegister8ToPtr, 1, [8], [0x02, 0x12, 0x22, 0x32,
    ...
    new OpcodeGroup(PrimaryGroupNames.ioPortWriteRegister8, 1, [8], [0xE2]),
    ...
    new OpcodeGroup(PrimaryGroupNames.ioPortReadRegister8, 2, [8], [0xF2]),
...
const extendedOpcodeGroups = [
    ...
    new OpcodeGroup(ExtendedGroupNames.testBitPtr, 1, [12], [0x46, 0x4E, 0x56, 0x5E, 0x66, 0x6E, 0x76, 0x7E]),
